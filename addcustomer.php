...
@media (max-width: 1250px) {
    .page-content { padding: 40px 20px; max-width: 100%; }
    .form-card { padding: 40px 50px; }
}
...
<main class="page-content">
    ...
    <div class="form-card">
        <div class="form-header">
            ...
            <p>Fill out the information below to add a new customer</p>
        </div>
        ...
        <form method="post">
            ...
            <button type="submit" name="add" class="btn-submit">Add Customer</button>
        </form>
    </div>
</main>
